    ...
    <div className="container" style={{ padding: "32px 0", maxWidth: 700 }}>
      ...
      <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div style={fieldWrapStyle}>
          <label style={fieldLabelStyle}>DNI del Proveedor *</label>
          <input
        ...
        <div style={fieldWrapStyle}>
          <label style={fieldLabelStyle}>Título de la Oferta *</label>
          <input
        ...
        <div style={grid2Style}>
          ...
          <div style={fieldWrapStyle}>
            <label style={fieldLabelStyle}>Personas Incluidas *</label>
            <input
              type="number"
              min="1"
              placeholder="1"
        ...
        <div style={grid2Style}>
          ...
          <div style={fieldWrapStyle}>
            <label style={fieldLabelStyle}>Disponible Hasta *</label>
            <input
              type="date"
              value={form.toISO}
        ...
        <div style={fieldWrapStyle}>
          <label style={fieldLabelStyle}>Capacidad Diaria *</label>
          <input
            type="number"
            min="1"
            placeholder="5"
